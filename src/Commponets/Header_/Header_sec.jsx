...
const Header_sec = () => {
    ...
    return (
        ...
        <>
            ...
            <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="open" aria-labelledby="offcanvasScrollingLabel">
                ...
                <div class="offcanvas-body">
                    ...
                    <nav>
                        ...
                        <Link to={'/'}><a className="shadow" href=""><i class="fa-solid fa-house"></i><span>الرئيسية</span></a></Link>
                        <Link to={'/we_are'}><a className="shadow" href=""><i class="fa-brands fa-weixin"></i><span>من نحن </span></a></Link>
                        <Link to={'/more'}><a className="shadow" href=""><i class="fa-solid fa-mobile"></i><span>عن التطبيق</span></a></Link>
                        <Link to={'/privacy_policy'}><a className="shadow" href=""><i class="fa-solid fa-lock-open"></i><span>سياسة الخصوصية</span></a></Link>
                        <Link to={'/soon'}><a className="shadow" href=""><i class="fa-solid fa-newspaper"></i><span>الاخبار</span></a></Link>                  
            ...
            <header className="header shadow">
                ...
                <div className="container">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4494.15 4432.36">
                        ...
                        <button className="bar"  data-bs-toggle="offcanvas" data-bs-target="#open" aria-controls="open">
