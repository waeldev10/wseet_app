...
import header_car from '../../images/header_car.svg';
import caar from '../../images/care.png';
import { useState,useEffect } from 'react';
import ShHead from '../Shemmers/ShHeade';
import Car from '../Shemmers/Car';
...
const Header = () => {
    ...
    return (
        ...
        <>
                    ...
                    <nav>
                        ...
                        <Link to={'/'}>
                            <a className="shadow" href="">
                                ...
                                <td><span>الرئيسية</span></td>
                            </a>
                        </Link>
                        <Link to={'/we_are'}>
                            <a className="shadow" href="">
                                <td><i class="fa-brands fa-weixin"></i></td>
                                <td><span>من نحن </span></td>
                            </a>
                        </Link>
                        <Link to={'/more'}>
                            <a className="shadow" href="">
                                <td><i class="fa-solid fa-mobile"></i></td>
                                <td><span>عن التطبيق</span></td>
                            </a>
                        </Link>
                        <Link to={'/privacy_policy'}>
                            <a className="shadow" href="">
                                <td><i class="fa-solid fa-lock-open"></i></td>
                                <td><span>سياسة الخصوصية</span></td>
                            </a>
                        </Link>
                        <Link to={'/soon'}>
                            <a className="shadow" href="">
                                <td><i class="fa-solid fa-newspaper"></i></td>
                                <td><span>الاخبار</span></td>
                            </a>
                        </Link>                  
            ...
            <header className="head mb-3 overflow-hidden position-relative">
                    <div className="red rounded-4 position-absolute"></div>
                    <div className="gray rounded-4 position-absolute"></div>
                    <div className="white rounded-4 position-absolute"></div>
                <div className="container position-relative ">

                   

                    <img src={header_car} className="header_car position-absolute w-100" alt="car"/>

                   
                    <div className="nav d-flex align-items-center justify-content-between py-3 position-relative">
                        ...
                        <nav>
                            ...
                            <Link to={'/'}><a href=""><i class="fa-solid fa-house"></i><span>الرئيسية</span></a></Link>
                            <Link to={'/we_are'}><a href=""><i class="fa-brands fa-weixin"></i><span>من نحن </span></a></Link>
                            <Link to={'/more'}><a href=""><i class="fa-solid fa-mobile"></i><span>عن التطبيق</span></a></Link>
                            <Link to={'/privacy_policy'}><a href=""><i class="fa-solid fa-lock-open"></i><span>سياسة الخصوصية</span></a></Link>
                            <Link to={'/soon'}><a href=""><i class="fa-solid fa-newspaper"></i><span>الاخبار</span></a></Link>                  

                        </nav>
                    
                        <a href="#footer" className="call-us py-1 px-3 rounded-2">تواصل معنا</a>
                        
                        <button className="bar"  data-bs-toggle="offcanvas" data-bs-target="#offcanvasScrolling" aria-controls="offcanvasScrolling">
                    ...
                    <article className="position-absolute w-100">
